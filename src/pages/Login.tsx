                ...
                {persistedUser ? (
                  <div className="w-full flex flex-col gap-4">
                     <button
                      ...
                      <button 
                        ...
                        className="w-full py-3 border border-slate-400 text-slate-600 font-display uppercase tracking-wider text-sm hover:text-danger hover:border-danger transition-all cursor-pointer hover:scale-[1.02] active:scale-95 rounded-xl block"
                      >
                  ...
                  <div className="w-full flex flex-col items-center">
                    <button 
                      ...
                      className="w-full py-4 bg-brand-500 hover:bg-brand-400 text-black font-bebas text-2xl tracking-widest transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed group hover:scale-[1.02] active:scale-95 shadow-[0_0_20px_rgba(201,255,0,0.2)] rounded-xl flex items-center justify-center gap-3 disabled:hover:scale-100"
                    >
